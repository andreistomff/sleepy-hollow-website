      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "Pensiunea GreenPanorama",
            "image": "/lovable-uploads/7fae8f2a-fdc9-47fc-85cd-525dfefa71ab.png",
            "url": "https://greenpanorama.ro",
            "telephone": "0744 530 505",
            "address": {
              "@type": "PostalAddress",
              "streetAddress": "DN64 70",
              "addressLocality": "Băile Olănești",
              "postalCode": "245306",
              "addressCountry": "RO"
            },
            "geo": {
      ...
      <footer className="bg-primary text-primary-foreground">
        <div className="container-custom py-12">
          ...
          <div className="border-t border-white/20 mt-12 pt-8 text-center">
            ...
            <p className="text-sm mt-2 text-primary-foreground/80">Website powered by <a href="https://codemelt.com/" target="_blank" rel="noopener noreferrer" className="underline hover:text-white">Codemelt</a>. Website made by A. Stomff.</p>
          </div>
        </div>
      </footer>
    </>
